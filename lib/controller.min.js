...
a.__dispatch(e,c,d);}else{d();}};},__dispatch:function(g,c,f){var b=this;var a=this._class.firstRoute(g.url)||this.config.index;var e=this.__handler(a);
if(this[a] instanceof Controller){g.url=this._class.shiftUrl(g.url);this[a].__dispatch(g,c,f);}else{if(this[e] instanceof Function&&this.__parse(g,c,a,e)){var h=domain.create();
