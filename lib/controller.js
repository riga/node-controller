/*!
 * node-controller module v0.2.11
...
var Controller = Emitter._extend({
  ...
  requireParams: function(req, keys, defaults, err) {
    ...
    if (!(keys instanceof Array)) {
      var value = req.param(keys);
      if (value == null && defaults == null) throw err;
      else return value != null ? value : defaults;
    } else {
      var values = {};
      keys.forEach(function(key) {
        var value = req.param(key);
        if (value == null && defaults[key] == null) throw err;
