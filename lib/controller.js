...
var Controller = Class._extend({
  ...
  restrictMethod: function(req, res, methods, statusOrCallback) {
  ...
  requireMethod: function(req, res, methods, statusOrCallback) {
    if (!(methods instanceof Array))
      methods = [methods];
    if (!~methods.indexOf(req.method)) {
      if (statusOrCallback instanceof Function)
  ...
  requireGET: function(req, res, statusOrCallback) {
    return this.requireMethod(req, res, ["GET"], statusOrCallback);
  },

  requirePOST: function(req, res, statusOrCallback) {
    return this.requireMethod(req, res, ["POST"], statusOrCallback);
  },

  requirePUT: function(req, res, statusOrCallback) {
    return this.requireMethod(req, res, ["PUT"], statusOrCallback);
  }
}, {
  // class members
